  ...
  return (
    <Grid container justifyContent="center" alignItems="center" style={{ minHeight: '100vh', padding: isSmallScreen ? '1rem' : '2rem' }}>
      <Grid item xs={12} sm={10} md={8} lg={6} xl={4} style={{ textAlign: 'center' }}>
        <Paper sx={{ backgroundColor: '#dcdcdc', padding: '2rem' }} elevation={15}>
          ...
          <Typography variant={isSmallScreen ? 'h4' : 'h3'} style={{ fontFamily: 'times', paddingTop: '1rem' }}>Login</Typography>
          <TextField
            variant="outlined"
            label="Email"
